...
$(function() {
    ...
    $(document).on('click', '.sidebar-control', function (e) {
      if($('.sidebar-control').hasClass("sidebar-xs")){
        // console.log('voltando ao normal')
        $('.sidebar-control').removeClass("sidebar-xs")
      }else{
        // console.log('minimizando o menu')
        $('.sidebar-control').addClass("sidebar-xs")
      }
        // containerHeight();
    });
